                ...
                <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="glass rounded-2xl overflow-hidden border border-white/10">
                    ...
                    <div className="p-4 sm:p-6">
                        ...
                        <motion.div variants={itemVariants} className="flex gap-3">
                            ...
                            <a href={projectData.repoUrl} target="_blank" rel="noopener noreferrer" className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-5 py-2.5 border border-neon-purple/50 text-neon-purple hover:bg-neon-purple/10 text-sm font-semibold rounded-lg hover:border-neon-purple transition-all">
