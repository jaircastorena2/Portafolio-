...
// Iconos con posiciones que no interfieren con el texto central
const floatingIcons = [
    // Solo en las esquinas, lejos del centro
...
const LoadingScreen = memo(function LoadingScreen({ onComplete }) {
    ...
    return (
        ...
        >
            ...
            {/* Floating icons - solo en desktop */}
            <div className="hidden md:block">
                {floatingIcons.map((item, index) => (
                    <motion.img
                        ...
                        style={{
                            left: `calc(50% + ${item.x * 3}px)`,
                            top: `calc(50% + ${item.y * 3}px)`,
                        }}
            ...
            <div className="text-center relative z-10 px-6">
                ...
                <motion.p
                    ...
                    className="text-text-muted text-sm md:text-base mb-6 tracking-widest"
                >
